        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-4">
            ...
            <h1 className="text-5xl font-semibold -tracking-widest text-foreground md:text-6xl">
              Know the plan before you lift the bar.
            </h1>
            <p className="max-w-2xl text-base leading-7 text-muted-foreground">
              Build your program, track your workouts, and see what&apos;s next.
            </p>
          </div>
            ...
            <CardContent className="grid gap-3 pt-4 sm:grid-cols-2 xl:grid-cols-3">
              <div className="rounded-2xl border border-border/70 bg-background/60 p-4">
                ...
                <p className="mt-1 text-sm leading-6 text-muted-foreground">
                  See program structure, strength profiles, and the trend lines that matter from week to week.
                </p>
              </div>
              <div className="rounded-2xl border border-border/70 bg-background/60 p-4">
                <div className="mb-3 flex size-10 items-center justify-center rounded-2xl bg-primary/12 text-primary">
