...
export const TRAINING_ADVISORY_COPY = 'PlateIQ helps you track and interpret training. It does not replace medical, rehab, or professional coaching judgment.'
